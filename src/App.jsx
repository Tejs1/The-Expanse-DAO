...
const App = () => {
  ...
  const vote = useVote("0x574d969a891C27B3d55714C0BB27c73FB250D591");
            ...
            >
              {proposals.map((proposal) => (
                <div key={proposal.proposalId} className="card">
                  <h3>{proposal.description.toUpperCase()}</h3>
              ...
              <div className="submit-btn">
                ...
                {!hasVoted && (
                  <small>
                    THIS WILL TRIGGER MULTIPLE TRANSACTIONS THAT USER WILL NEED
                    TO SIGN
                  </small>
                )}
              </div>
  ...
  return (
    <div className="mint-nft landing">
      <h1>
        <p>Mint your FREE 🍪DAO MEmBersHip NFT</p>
      </h1>
